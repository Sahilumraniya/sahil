            ...
            <div className="container mx-auto px-4 sm:px-6">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    >
                        ...
                        <p className="text-lg text-slate-600 dark:text-slate-400 leading-relaxed">
                            When I'm not debugging a race condition in Node.js or fine-tuning a React component, you can find me exploring the latest in Generative AI or architecting **sophisticated developer tools** like my own <span className="text-violet-600 font-semibold">Retro Table</span>.
                        </p>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <motion.div whileHover={{ y: -5 }} className="bg-white dark:bg-white/5 p-6 rounded-2xl border border-slate-200 dark:border-white/10 shadow-sm">
                        ...
                        <motion.div whileHover={{ y: -5 }} className="bg-white dark:bg-white/5 p-6 rounded-2xl border border-slate-200 dark:border-white/10 shadow-sm mt-8">
